...
polls_data <- readRDS("data/polls.rds")
elo_data <- readRDS("data/elo.rds")
srs_data <- readRDS("data/srs.rds")
sp_data <- readRDS("data/sp.rds")
fpi_data <- readRDS("data/fpi.rds")
